...
class CapitalT(object):
    ...
    def move_by(self, dx, dy):
        ...
        # --------------------------------------------------------------
        c1 = self.h_rect.corner_1
        c2 = self.h_rect.corner_2
        ...
        c1 = self.v_rect.corner_1
        c2 = self.v_rect.corner_2
    ...
    def clone(self):
        ...
        #     clone.pdf.
        # --------------------------------------------------------------
        new_h_rect = self.h_rect
        new_v_rect = self.v_rect
        new_capital_t = CapitalT(new_h_rect.get_center(), new_h_rect.get_width(),
                                 new_v_rect.get_height(), new_v_rect.get_width())
        new_capital_t.set_colors(new_h_rect.fill_color, new_h_rect.outline_color)
